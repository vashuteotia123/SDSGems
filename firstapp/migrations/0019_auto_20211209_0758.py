...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('firstapp', '0018_salesreturn_cs_clarity'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='color_of_colorstone',
            options={'verbose_name_plural': 'ColourStone - Colour'},
        ),
        migrations.AlterModelOptions(
            name='color_origin',
            options={'verbose_name_plural': 'Diamond - Colour Origin'},
        ),
        migrations.AlterModelOptions(
            name='gemtype',
            options={'verbose_name_plural': 'ColourStone - Gemtype'},
        ),
